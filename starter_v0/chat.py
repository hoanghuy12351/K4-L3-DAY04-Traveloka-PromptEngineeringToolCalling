...
def main() -> None:
    parser = argparse.ArgumentParser(description="Interactive AI Travel Planner chat with transcript logging.")
    ...
    print(f"AI Travel Planner chat. artifact_version={artifact_version.artifact_version}")
